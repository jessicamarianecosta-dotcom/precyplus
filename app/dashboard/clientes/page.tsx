...
// STORAGE
const CLIENTS_KEY = 'precy_clients';
...
const DEMO: Client[] = [
  {
    ...
    email: 'ana@email.com',
    observations:
      'Gosta de personalizados florais',
    created_at: '',
  },
];
      ...
      {filtered.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
          ...
          {filtered.map(c => (
            ...
            <div
              key={c.id}
              className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm card-hover group"
            >
              ...
              {c.observations && (
                ...
                <p className="text-xs text-gray-500 font-semibold mb-3 bg-gray-50 rounded-lg px-3 py-2">
                  {c.observations}
                </p>
